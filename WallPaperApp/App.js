...
export default class App extends React.Component {
      ...
      <View style={{ flex: 1 }}>
        ...
        />
          <ActivityIndicator style={{position: 'absolute',
            ...
            left: 0,
            right: 0,
            bottom: 0,}}size="large" color="white" />
        </View>
        ...
        >
          ...
          >
            ...
            >
              <Ionicons name="md-refresh" color="white" size={35} />
            </TouchableOpacity>
          </View>
          <View
            style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}
          >
            ...
            >
              <Ionicons name="md-download" color="white" size={50} />
            </TouchableOpacity>
          </View>
          <View
            style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}
          >
            ...
            >
              <Ionicons name="md-send" color="white" size={35} />
            </TouchableOpacity>
          </View>
        </Animated.View>
      </View>
  ...
  render() {
    ...
    bottom: 0,}} size="large" color="white" />
      ...
      <View style={{ flex: 1, backgroundColor: '#4B0F33' }}>
        <FlatList
